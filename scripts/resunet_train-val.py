...
def model_fn(features, labels, mode, params):
    ...
    # Model Definition
    model_output_ops = residual_unet_3d(
        inputs                   = features['x'],
        num_res_units            = 2,
    ...
    image_summaries = {}
    image_summaries['MRI_Patch']   = features['x'][0, 50, :, :, 0]
    image_summaries['Predictions'] = tf.cast(model_output_ops['y_'], tf.float32)[0, 50, :, :]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path',   '-p', default='/home/cad1/anindo/neuro/model_weights/test/ensemble/resunet112-250E/')
